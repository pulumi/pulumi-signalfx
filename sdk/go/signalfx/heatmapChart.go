...
// Tags associated with the resource
func (o HeatmapChartOutput) Tags() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *HeatmapChart) pulumi.StringArrayOutput { return v.Tags }).(pulumi.StringArrayOutput)
}
