...
class AlertMutingRuleFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] negated: Determines if this is a "not" filter. Defaults to `false`.
        """
    ...
    def property_value(self) -> pulumi.Input[_builtins.str]:
        """
        The property value to filter.
        """
    ...
    def property_value(self, value: pulumi.Input[_builtins.str]):
...
class AlertMutingRuleRecurrenceArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.str] unit: The unit of the period. Can be days (d) or weeks (w).
        :param pulumi.Input[_builtins.int] value: The amount of time, expressed as an integer, applicable to the unit specified.
        """
...
class DashboardChartArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] height: How many rows the chart should take up (greater than or equal to `1`). `1` by default.
        :param pulumi.Input[_builtins.int] row: The row to show the chart in (zero-based); if `height > 1`, this value represents the topmost row of the chart (greater than or equal to `0`).
        :param pulumi.Input[_builtins.int] width: How many columns (out of a total of 12) the chart should take up (between `1` and `12`). `12` by default.
        """
...
class DashboardColumnArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] width: How many columns (out of a total of `12`) every chart should take up (between `1` and `12`). `12` by default.
        """
    ...
    def chart_ids(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        List of IDs of the charts to display.
        """
    ...
    @chart_ids.setter
    def chart_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class DashboardEventOverlayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] label: Text shown in the dropdown when selecting this overlay from the menu.
        :param pulumi.Input[_builtins.bool] line: Show a vertical line for the event. `false` by default.
        ...
        :param pulumi.Input[_builtins.str] type: Can be set to `eventTimeSeries` (the default) to refer to externally reported events, or `detectorEvents` to refer to events from detector triggers.
        """
...
class DashboardFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] apply_if_exist: If true, this filter will also match data that doesn't have this property at all.
        :param pulumi.Input[_builtins.bool] negated: Whether this filter should be a not filter. `false` by default.
        """
        pulumi.set(__self__, "property", property)
        pulumi.set(__self__, "values", values)
...
class DashboardGroupImportQualifierFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] property: A metric time series dimension or property name
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] values: List of strings (which will be treated as an OR filter on the property)
        :param pulumi.Input[_builtins.bool] negated: (false by default) Whether this filter should be a "not" filter
        """
        pulumi.set(__self__, "property", property)
        pulumi.set(__self__, "values", values)
        if negated is not None:
...
class DashboardGroupPermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] actions: Action the user, team, or organization can take with the dashboard group. List of values (value can be "READ" or "WRITE").
        """
...
class DashboardPermissionsAclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] principal_id: ID of the user, team, or organization for which you're granting permissions.
        :param pulumi.Input[_builtins.str] principal_type: Clarify whether this permission configuration is for a user, a team, or an organization. Value can be one of "USER", "TEAM", or "ORG".
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] actions: Action the user, team, or organization can take with the dashboard. List of values (value can be "READ" or "WRITE").
        """
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "principal_type", principal_type)
        if actions is not None:
...
class DashboardVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] property: A metric time series dimension or property name.
        :param pulumi.Input[_builtins.bool] apply_if_exist: If true, this variable will also match data that doesn't have this property at all.
        :param pulumi.Input[_builtins.str] description: Variable description.
        :param pulumi.Input[_builtins.bool] replace_only: If `true`, this variable will only apply to charts that have a filter for the property.
        :param pulumi.Input[_builtins.bool] restricted_suggestions: If `true`, this variable may only be set to the values listed in `values_suggested` and only these values will appear in autosuggestion menus. `false` by default.
        :param pulumi.Input[_builtins.bool] value_required: Determines whether a value is required for this variable (and therefore whether it will be possible to view this dashboard without this filter applied). `false` by default.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] values: List of of strings (which will be treated as an OR filter on the property).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] values_suggesteds: A list of strings of suggested values for this variable; these suggestions will receive priority when values are autosuggested for this variable.
        """
...
class DataLinkTargetAppdUrlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] url: URL string for an AppDynamics instance.
        """
...
class DataLinkTargetExternalUrlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] minimum_time_window: The [minimum time window](https://dev.splunk.com/observability/docs/administration/datalinks/) for a search sent to an external site. Defaults to `6000`
        ...
        :param pulumi.Input[_builtins.str] time_format: [Designates the format](https://dev.splunk.com/observability/docs/administration/datalinks/) of `minimum_time_window` in the same data link target object. Must be one of `"ISO8601"`, `"EpochSeconds"` or `"Epoch"` (which is milliseconds). Defaults to `"ISO8601"`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "url", url)
...
class DataLinkTargetSignalfxDashboardArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: User-assigned target name. Use this value to differentiate between the link targets for a data link object.
        :param pulumi.Input[_builtins.bool] is_default: Flag that designates a target as the default for a data link object. `true` by default
        """
    ...
    def dashboard_group_id(self) -> pulumi.Input[_builtins.str]:
        """
        SignalFx-assigned ID of the dashboard link target's dashboard group
        """
    ...
    def dashboard_group_id(self, value: pulumi.Input[_builtins.str]):
...
class DetectorRuleArgs:
    ...
    def detect_label(self) -> pulumi.Input[_builtins.str]:
        """
        A detect label which matches a detect label within `program_text`.
        """
    ...
    @detect_label.setter
    def detect_label(self, value: pulumi.Input[_builtins.str]):
...
class DetectorRuleReminderNotificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] timeout_ms: The duration during which repeat notifications are sent, in milliseconds.
        """
    ...
    def interval_ms(self) -> pulumi.Input[_builtins.int]:
        """
        The interval at which you want to receive the notifications, in milliseconds.
        """
    ...
    @interval_ms.setter
    def interval_ms(self, value: pulumi.Input[_builtins.int]):
...
class DetectorVizOptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] value_unit: A unit to attach to this plot. Units support automatic scaling (eg thousands of bytes will be displayed as kilobytes). Values values are `Bit, Kilobit, Megabit, Gigabit, Terabit, Petabit, Exabit, Zettabit, Yottabit, Byte, Kibibyte, Mebibyte, Gibibyte (note: this was previously typoed as Gigibyte), Tebibyte, Pebibyte, Exbibyte, Zebibyte, Yobibyte, Nanosecond, Microsecond, Millisecond, Second, Minute, Hour, Day, Week`.
        """
        pulumi.set(__self__, "label", label)
        if color is not None:
            pulumi.set(__self__, "color", color)
...
class HeatmapChartColorRangeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] min_value: The minimum value within the coloring range.
        """
        pulumi.set(__self__, "color", color)
...
class HeatmapChartColorScaleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] gte: Indicates the lower threshold inclusive value for this range.
        :param pulumi.Input[_builtins.float] lt: Indicates the upper threshold non-inclusive value for this range.
        :param pulumi.Input[_builtins.float] lte: Indicates the upper threshold inclusive value for this range.
        """
        pulumi.set(__self__, "color", color)
        if gt is not None:
...
class ListChartColorScaleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] gt: Indicates the lower threshold non-inclusive value for this range.
        :param pulumi.Input[_builtins.float] gte: Indicates the lower threshold inclusive value for this range.
        :param pulumi.Input[_builtins.float] lt: Indicates the upper threshold non-inculsive value for this range.
        :param pulumi.Input[_builtins.float] lte: Indicates the upper threshold inclusive value for this range.
        """
        pulumi.set(__self__, "color", color)
        if gt is not None:
...
class MetricRulesetAggregationRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Information about an aggregation rule
        :param pulumi.Input[_builtins.str] name: name of the aggregation rule
        """
...
if not MYPY:
    class MetricRulesetAggregationRuleAggregatorArgsDict(TypedDict):
        ...
        """
        drop_dimensions: pulumi.Input[_builtins.bool]
        """
...
class MetricRulesetAggregationRuleAggregatorArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dimensions: List of dimensions to either be kept or dropped in the new aggregated MTSs
        :param pulumi.Input[_builtins.bool] drop_dimensions: when true, the specified dimensions will be dropped from the aggregated MTSs
        :param pulumi.Input[_builtins.str] output_name: name of the new aggregated metric
        :param pulumi.Input[_builtins.str] type: Type of aggregator. Must always be "rollup"
        """
    ...
    def drop_dimensions(self) -> pulumi.Input[_builtins.bool]:
        """
        when true, the specified dimensions will be dropped from the aggregated MTSs
        """
    ...
    def drop_dimensions(self, value: pulumi.Input[_builtins.bool]):
...
if not MYPY:
    class MetricRulesetAggregationRuleMatcherFilterArgsDict(TypedDict):
        not_: pulumi.Input[_builtins.bool]
        """
...
class MetricRulesetAggregationRuleMatcherFilterArgs:
    def __init__(__self__, *,
                 ...
                 property_values: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        """
        :param pulumi.Input[_builtins.bool] not_: When true, this filter will match all values not matching the property_values
        :param pulumi.Input[_builtins.str] property: Name of the dimension
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] property_values: Value of the dimension
        """
    ...
    def not_(self) -> pulumi.Input[_builtins.bool]:
        """
        When true, this filter will match all values not matching the property_values
        """
    ...
    @not_.setter
    def not_(self, value: pulumi.Input[_builtins.bool]):
...
class MetricRulesetExceptionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Information about an exception rule
        :param pulumi.Input[_builtins.str] name: name of the exception rule
...
class MetricRulesetExceptionRuleRestorationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] stop_time: Time to which the restoration job will restore archived data, in the form of *nix time in milliseconds
        """
...
class MetricRulesetRoutingRuleArgs:
    def __init__(__self__, *,
                 destination: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] destination: end destination of the input metric. Must be `RealTime`, `Archived`, or `Drop`
        """
...
class OrgTokenDpmLimitsArgs:
    ...
    def dpm_limit(self) -> pulumi.Input[_builtins.int]:
        """
        The datapoints per minute (dpm) limit for this token. If you exceed this limit, Splunk Observability Cloud sends out an alert.
        """
    ...
    @dpm_limit.setter
    def dpm_limit(self, value: pulumi.Input[_builtins.int]):
...
class OrgTokenHostOrUsageLimitsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] custom_metrics_limit: Max number of custom metrics that can be sent with this token
        :param pulumi.Input[_builtins.int] custom_metrics_notification_threshold: Notification threshold for custom metrics
        :param pulumi.Input[_builtins.int] high_res_metrics_limit: Max number of hi-res metrics that can be sent with this toke
        :param pulumi.Input[_builtins.int] high_res_metrics_notification_threshold: Notification threshold for hi-res metrics
        :param pulumi.Input[_builtins.int] host_limit: Max number of hosts that can use this token
        :param pulumi.Input[_builtins.int] host_notification_threshold: Notification threshold for hosts
        """
...
class SloInputArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] total_events_label: Label used in `"program_text"` that refers to the data block which contains the stream of total events
        """
...
class SloTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: SLO target type can be the following type: `"RollingWindow"`, `"CalendarWindow"`
        :param pulumi.Input[_builtins.str] compliance_period: Compliance period of this SLO. This value must be within the range of 1d (1 days) to 30d (30 days), inclusive.
        :param pulumi.Input[_builtins.str] cycle_start: It can be used to change the cycle start time. For example, you can specify sunday as the start of the week (instead of the default monday)
        :param pulumi.Input[_builtins.str] cycle_type: The cycle type of the calendar window, e.g. week, month.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def slo(self) -> pulumi.Input[_builtins.float]:
        """
        Target value in the form of a percentage
        """
    ...
    @slo.setter
    def slo(self, value: pulumi.Input[_builtins.float]):
...
class SloTargetAlertRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: SLO alert rule can be one of the following types: BREACH, ERROR_BUDGET_LEFT, BURN_RATE. Within an SLO object, you can only specify one SLO alert_rule per type. For example, you can't specify two alert_rule of type BREACH. See [SLO alerts](https://docs.splunk.com/observability/en/alerts-detectors-notifications/slo/burn-rate-alerts.html) for more info.
        """
...
class SloTargetAlertRuleRuleParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] fire_lasting: Duration that indicates how long the alert condition is met before the alert is triggered. The value must be positive and smaller than the compliance period of the SLO target. Note: `"BREACH"` and `"ERROR_BUDGET_LEFT"` alert rules use the fireLasting parameter. Default: `"5m"`
        :param pulumi.Input[_builtins.str] long_window1: Long window 1 used in burn rate alert calculation. This value must be longer than `"short_window_1"` and shorter than 90 days. Note: `"BURN_RATE"` alert rules use the `"long_window_1"` parameter. See [SLO alerts](https://docs.splunk.com/observability/en/alerts-detectors-notifications/slo/burn-rate-alerts.html) for more info.
        :param pulumi.Input[_builtins.str] long_window2: Long window 2 used in burn rate alert calculation. This value must be longer than `"short_window_2"` and shorter than 90 days. Note: `"BURN_RATE"` alert rules use the `"long_window_2"` parameter. See [SLO alerts](https://docs.splunk.com/observability/en/alerts-detectors-notifications/slo/burn-rate-alerts.html) for more info.
        :param pulumi.Input[_builtins.float] percent_error_budget_left: Error budget must be equal to or smaller than this percentage for the alert to be triggered. Note: `"ERROR_BUDGET_LEFT"` alert rules use the `"percent_error_budget_left"` parameter. Default: `100`
        :param pulumi.Input[_builtins.float] percent_of_lasting: Percentage of the `"fire_lasting"` duration that the alert condition is met before the alert is triggered. Note: `"BREACH"` and `"ERROR_BUDGET_LEFT"` alert rules use the `"percent_of_lasting"` parameter. Default: `100`
        :param pulumi.Input[_builtins.str] short_window1: Short window 1 used in burn rate alert calculation. This value must be longer than 1/30 of `"long_window_1"`. Note: `"BURN_RATE"` alert rules use the `"short_window_1"` parameter. See [SLO alerts](https://docs.splunk.com/observability/en/alerts-detectors-notifications/slo/burn-rate-alerts.html) for more info.
        :param pulumi.Input[_builtins.str] short_window2: Short window 2 used in burn rate alert calculation. This value must be longer than 1/30 of `"long_window_2"`. Note: `"BURN_RATE"` alert rules use the `"short_window_2"` parameter. See [SLO alerts](https://docs.splunk.com/observability/en/alerts-detectors-notifications/slo/burn-rate-alerts.html) for more info.
        """
...
class TableChartVizOptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] color: Color to use
        :param pulumi.Input[_builtins.str] display_name: Specifies an alternate value for the Plot Name column of the Data Table associated with the chart.
        :param pulumi.Input[_builtins.str] value_prefix: An arbitrary prefix to display with the value of this plot
        :param pulumi.Input[_builtins.str] value_suffix: An arbitrary suffix to display with the value of this plot
        :param pulumi.Input[_builtins.str] value_unit: A unit to attach to this plot. Units support automatic scaling (eg thousands of bytes will be displayed as kilobytes)
        """
        pulumi.set(__self__, "label", label)
        if color is not None:
            pulumi.set(__self__, "color", color)
...
class TimeChartAxisLeftArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] label: Label of the left axis.
        :param pulumi.Input[_builtins.float] low_watermark: A line to draw as a low watermark.
        :param pulumi.Input[_builtins.str] low_watermark_label: A label to attach to the low watermark line.
        :param pulumi.Input[_builtins.float] max_value: The maximum value for the left axis.
        :param pulumi.Input[_builtins.float] min_value: The minimum value for the left axis.
        """
...
class TimeChartAxisRightArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] high_watermark: A line to draw as a high watermark.
        :param pulumi.Input[_builtins.str] high_watermark_label: A label to attach to the high watermark line.
        :param pulumi.Input[_builtins.str] label: Label of the right axis.
        :param pulumi.Input[_builtins.float] low_watermark: A line to draw as a low watermark.
        :param pulumi.Input[_builtins.str] low_watermark_label: A label to attach to the low watermark line.
        :param pulumi.Input[_builtins.float] max_value: The maximum value for the right axis.
        :param pulumi.Input[_builtins.float] min_value: The minimum value for the right axis.
        """
        if high_watermark is not None:
            pulumi.set(__self__, "high_watermark", high_watermark)
        if high_watermark_label is not None:
...
class WebhookIntegrationHeaderArgs:
    def __init__(__self__, *,
                 ...
                 header_value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] header_key: The key of the header to send
        :param pulumi.Input[_builtins.str] header_value: The value of the header to send
        """
