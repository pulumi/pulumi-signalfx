...
class HeatmapChart(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] group_bies: Properties to group by in the heatmap (in nesting order).
