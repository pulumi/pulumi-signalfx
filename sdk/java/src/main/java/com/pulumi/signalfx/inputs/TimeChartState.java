...
public final class TimeChartState extends com.pulumi.resources.ResourceArgs {

    public static final TimeChartState Empty = new TimeChartState();
    ...
    private TimeChartState() {}

    private TimeChartState(TimeChartState $) {
    ...
    public static Builder builder(TimeChartState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(TimeChartState defaults) {
            $ = new TimeChartState(Objects.requireNonNull(defaults));
        }
