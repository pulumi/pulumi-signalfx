...
public final class TableChartArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TableChartArgs() {}

    private TableChartArgs(TableChartArgs $) {
    ...
    public static Builder builder(TableChartArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(TableChartArgs defaults) {
            $ = new TableChartArgs(Objects.requireNonNull(defaults));
        }
