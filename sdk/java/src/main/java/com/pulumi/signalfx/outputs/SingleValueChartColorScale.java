...
@CustomType
public final class SingleValueChartColorScale {
    /**
    ...
    private SingleValueChartColorScale(
    ...
    public static Builder builder(SingleValueChartColorScale defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SingleValueChartColorScale defaults) {
        ...
        public Builder lte(@Nullable Double lte) {
            ...
            return new SingleValueChartColorScale(color, gt, gte, lt, lte);
        }
    }
}
