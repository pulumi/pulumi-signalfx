...
public final class HeatmapChartColorScaleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The color range to use. Hex values are not supported here. Must be one of red, gold, iris, green, jade, gray, blue, azure, navy, brown, orange, yellow, magenta, cerise, pink, violet, purple, lilac, emerald, chartreuse, yellowgreen, aquamarine.
     * 
     */
    ...
    private HeatmapChartColorScaleArgs() {}

    private HeatmapChartColorScaleArgs(HeatmapChartColorScaleArgs $) {
        this.color = $.color;
        this.gt = $.gt;
        this.gte = $.gte;
        this.lt = $.lt;
    ...
    public static Builder builder(HeatmapChartColorScaleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HeatmapChartColorScaleArgs();
        }

        public Builder(HeatmapChartColorScaleArgs defaults) {
            $ = new HeatmapChartColorScaleArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param color The color range to use. Hex values are not supported here. Must be one of red, gold, iris, green, jade, gray, blue, azure, navy, brown, orange, yellow, magenta, cerise, pink, violet, purple, lilac, emerald, chartreuse, yellowgreen, aquamarine.
         * 
         * @return builder
         * 
         */
        ...
        public HeatmapChartColorScaleArgs build() {
            if ($.color == null) {
                throw new MissingRequiredPropertyException("HeatmapChartColorScaleArgs", "color");
            }
            return $;
        }
    }
