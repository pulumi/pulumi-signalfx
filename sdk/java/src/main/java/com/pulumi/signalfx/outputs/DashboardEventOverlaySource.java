...
public final class DashboardEventOverlaySource {
    ...
    public static Builder builder(DashboardEventOverlaySource defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(DashboardEventOverlaySource defaults) {
        ...
        public Builder property(String property) {
            if (property == null) {
              throw new MissingRequiredPropertyException("DashboardEventOverlaySource", "property");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("DashboardEventOverlaySource", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public DashboardEventOverlaySource build() {
            final var _resultValue = new DashboardEventOverlaySource();
