...
public final class DashboardSelectedEventOverlaySource {
    ...
    public static final class Builder {
        ...
        public Builder property(String property) {
            if (property == null) {
              throw new MissingRequiredPropertyException("DashboardSelectedEventOverlaySource", "property");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("DashboardSelectedEventOverlaySource", "values");
            }
            this.values = values;
            return this;
        }
