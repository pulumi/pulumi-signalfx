...
public final class EventFeedChartState extends com.pulumi.resources.ResourceArgs {
    ...
    private EventFeedChartState() {}

    private EventFeedChartState(EventFeedChartState $) {
    ...
    public static Builder builder(EventFeedChartState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EventFeedChartState();
        }

        public Builder(EventFeedChartState defaults) {
            $ = new EventFeedChartState(Objects.requireNonNull(defaults));
        }
        ...
        public EventFeedChartState build() {
            return $;
        }
    }
