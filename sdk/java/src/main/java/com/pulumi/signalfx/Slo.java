 ...
 * ### Email
 * 
 * Optional **Cc** and **Bcc**: `Email,to{@literal @}example.com,cc1|cc2,bcc1` (use `|` between multiple addresses in Cc or Bcc). Requires org feature `emailNotificationCcBccEnabled`.
 * 
 * ### Jira
 * 
